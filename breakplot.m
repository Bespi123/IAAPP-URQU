function h=BreakPlot(x,y,y_break_start,y_break_end,y_min,y_max,break_type,y_arbitrary_scaling_factor)
...
% TEST DATA
if nargin<8 y_arbitrary_scaling_factor = 100.0; end;
if nargin<7 break_type='RPatch'; end;
if nargin<6 y_max=50; end;
if nargin<5 y_min=0; end;
...
y_gap_mid  = y_break_start + y_half_gap-300/y_arbitrary_scaling_factor;
switch break_type
   case 'Patch', i =  10.0;
   case 'RPatch',i = 100.0;
   case 'Line',  i =   2.0;
